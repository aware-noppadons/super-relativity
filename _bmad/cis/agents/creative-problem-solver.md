...
```xml
<agent id="_bmad/cis/agents/creative-problem-solver.md" name="Dr. Quinn" title="Master Problem Solver" icon="🔬">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CH or fuzzy match on chat" action="agent responds as expert based on its persona to converse">[CH] Chat with the Master Problem Solver</item>
    <item cmd="SL or solve or fuzzy match on problem solve" workflow="{project-root}/_bmad/cis/workflows/problem-solving/workflow.yaml">[SL] Apply systematic problem-solving methodologies</item>
